...
if ( !defined('ch2mlm')  || !defined('ABSPATH') ) {
  exit;
}

add_action('admin_menu', 'ch2_mlm_admin_menu');

function ch2_mlm_admin_menu()
{
  // SVG icon for the menu (instead of Dashicons)
  ...
  add_menu_page(
    ...
    'manage_options',
    'ch2-mlm-main-menu',
    'ch2_mlm_complex_main',
    'data:image/svg+xml;base64,' . base64_encode($menu_icon)
  );

  // Create a sub-menu under the top-level one
  add_submenu_page(
    'ch2-mlm-main-menu',
